...
import { BURRY_BONE_COLLECTION } from '../Database/constants';
...
export default async function getDistribution(options: Options) {
    ...
    const WEEK = 3;
    const REWARD_WEEK = 0;
    const REWARD_AMOUNT = 14657.28;   //33% of total rewards
    ...
    const REWARD_TOKEN = "BONE_BONE"
    const CONTRACT = "BuryBone"
